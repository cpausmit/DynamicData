...
then
  ...
  ssh t3btch001 $SMARTCACHE_DIR/Client/addDownloadRequest.py --file=06425000-70FA-E111-B50A-00304867C034.root --dataset=$DSET --book=$BOOK
  ...
  ssh t3btch010 $SMARTCACHE_DIR/Client/addDownloadRequest.py --file=A2BE3068-69FA-E111-91CF-0026189438BF.root --dataset=$DSET --book=$BOOK
  ssh t3btch013 $SMARTCACHE_DIR/Client/addDownloadRequest.py --file=A8E5B675-6CFA-E111-83D5-003048678A80.root --dataset=$DSET --book=$BOOK
